...
const SITEMAPS = [
  { name: "Sitemap Index", url: "/api/sitemap/", description: "Main index linking all sitemaps", icon: FiLayers, color: "bg-gradient-to-br from-primary to-secondary", key: "Index" },
  { name: "Static Pages", url: "/api/sitemap/pages/", description: "Homepage, about, contact, policies", icon: FiGlobe, color: "bg-gradient-to-br from-blue-500 to-blue-600", key: "Pages" },
  { name: "Blog Posts", url: "/api/sitemap/posts/", description: "All approved blog posts", icon: FiFileText, color: "bg-gradient-to-br from-green-500 to-green-600", key: "Posts" },
  { name: "Manga", url: "/api/sitemap/manga/", description: "All manga main pages", icon: FiBook, color: "bg-gradient-to-br from-purple-500 to-purple-600", key: "Manga" },
  { name: "Categories", url: "/api/sitemap/categories/", description: "Blog category pages", icon: FiGrid, color: "bg-gradient-to-br from-orange-500 to-orange-600", key: "Categories" },
  { name: "Giveaways", url: "/api/sitemap/giveaways/", description: "Active and past giveaways", icon: FiGift, color: "bg-gradient-to-br from-pink-500 to-pink-600", key: "Giveaways" },
];
