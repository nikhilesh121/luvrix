...
export async function createGiveaway(data) {
  ...
  const giveaway = {
    ...
    maxExtensions: data.maxExtensions != null ? Number(data.maxExtensions) : 0,
    extensionsUsed: 0,
...
export async function updateGiveaway(id, data) {
  ...
  if (updateData.maxExtensions !== undefined) updateData.maxExtensions = updateData.maxExtensions != null ? Number(updateData.maxExtensions) : 0;
